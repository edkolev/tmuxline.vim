...
fun! tmuxline#util#create_theme_from_lightline(mode_palette)
  ...
  let theme = {
        \'a' : [ a:mode_palette.left[s:FG][0],a:mode_palette.left[s:FG][1] ]+a:mode_palette.left[s:FG][4:4],
        \'b' : [ a:mode_palette.left[s:BG][0],a:mode_palette.left[s:BG][1] ]+a:mode_palette.left[s:BG][4:4],
        \'c' : [ a:mode_palette.middle[s:FG][0],a:mode_palette.middle[s:FG][1] ]+a:mode_palette.middle[s:FG][4:4],
        \'x' : [ a:mode_palette.middle[s:FG][0],a:mode_palette.middle[s:FG][1] ]+a:mode_palette.middle[s:FG][4:4],
        \'y' : [ a:mode_palette.right[s:BG][0],a:mode_palette.right[s:BG][1] ]+a:mode_palette.right[s:BG][4:4],
        \'z' : [ a:mode_palette.right[s:FG][0],a:mode_palette.right[s:FG][1] ]+a:mode_palette.right[s:FG][4:4],
        \'bg' : [ a:mode_palette.middle[s:FG][0],a:mode_palette.middle[s:FG][1] ]+a:mode_palette.middle[s:FG][4:4],
        \'cwin' : [ a:mode_palette.left[s:BG][0],a:mode_palette.left[s:BG][1] ]+a:mode_palette.left[s:BG][4:4],
        \'win' : [ a:mode_palette.middle[s:FG][0],a:mode_palette.middle[s:FG][1] ]+a:mode_palette.middle[s:FG][4:4]}
  else
  let theme = {
